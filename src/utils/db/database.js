...
const database = {
  ...
  mySkills: [
    ...
    {
      title:'JavaScript',
      logo: '/resume/skillicons/JavaScript.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
    {
      title:'Python',
      logo: '/resume/skillicons/python.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },    
    {
    ...
    {
      title:'C#',
      logo: '/resume/skillicons/C.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
    {
      title:'Node',
      logo: '/resume/skillicons/node.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
    {
      title:'Jest',
      logo: '/resume/skillicons/jest.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },    
    {
      title:'Docker',
      logo: '/resume/skillicons/docker.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
    {
      title:'Git',
      logo: '/resume/skillicons/git.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
    {
      title:'MongoDB',
      logo: '/resume/skillicons/mongodb.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
    {
      title:'REACT.NET',
      logo: '/resume/skillicons/reactnet.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },    
    {
    ...
    {
      title:'CI/CD',
      logo: '/resume/skillicons/cicg.png',
      years: 2,
      placesUsed: ['Amex', 'SAFCO', 'FAU','JHU','Personal'],
    },
  ],
...
Mock.onGet("/api/myskills").reply(config => {
  const response = database.mySkills;
  return [200, response];
});
